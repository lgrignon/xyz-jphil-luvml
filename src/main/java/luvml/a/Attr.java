 ...
 * @author
 */
public class Attr implements AttributeDefinition_I{
    private final String name;
    private final boolean hasQuotes,hasEqualSign,hasValue;

    public Attr(String name, boolean hasQuotes, boolean hasEqualSign, boolean hasValue) {
        this.name = name;
    ...
    public static Attr named(String name){
        return new Attr(name, true, true, true);
    }
    
    public static Attr null_valued(String name){
